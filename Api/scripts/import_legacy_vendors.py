        ...
        payload.append(
            {
                ...
                "vendor": {
                    ...
                    "phoneCountryCode": first_nonempty(vendor.get("countryCode")) or "+971",
                    "primaryMobileCountryCode": first_nonempty(vendor.get("countryCode")) or "+971",
                    "addressLine1": first_nonempty(vendor.get("address")) or "Not provided",
...
INSERT INTO vendors (
  ...
  "ibanNo", "accountNumber", swift, "branchAddress", "appleId", "phoneCountryCode",
  "primaryMobileCountryCode", "addressLine1", "addressLine2", landmark, "poBox",
...
ON CONFLICT (old_vendor_id) DO UPDATE SET
  ...
  "primaryMobileCountryCode" = EXCLUDED."primaryMobileCountryCode",
