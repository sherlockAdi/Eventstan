...
// Sample blog post for editing demo
const sampleBlogPost = {
  ...
  hashtags: ['weddingtips', 'perfectwedding', 'weddingplanning'],
...
export default function EditBlogPost() {
  ...
  useEffect(() => {
    ...
    const fetchPost = async () => {
      try {
        // Here you would make an API call to fetch the post by ID
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Updating blog post:', submitData);
