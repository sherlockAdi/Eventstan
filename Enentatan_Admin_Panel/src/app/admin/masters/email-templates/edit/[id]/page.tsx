...
const getRole = (id: number): any => {
  const roles: Record<number, any> = {
    1: { id: 1, name: 'Super Admin', description: 'Full system access', status: 'Active', permissions: modules.map(m => ({ module: m, view: true, create: true, edit: true, delete: true })) },
    2: { id: 2, name: 'Manager', description: 'Manage vendors, bookings, users', status: 'Active', permissions: modules.map(m => ({ module: m, view: true, create: m !== 'Reports', edit: m !== 'Reports', delete: false })) },
    3: { id: 3, name: 'Support', description: 'View only access', status: 'Active', permissions: modules.map(m => ({ module: m, view: true, create: false, edit: false, delete: false })) },
  };
  return roles[id];
};
...
export default function EditRolePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push('/admin/masters/role-permission');
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/admin/masters/role-permission">
